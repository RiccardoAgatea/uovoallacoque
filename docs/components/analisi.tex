...
Gli utenti che hanno già un'idea chiara su cosa cercare all'interno del sito, possono utlizzare la barra di ricerca, visibile nell'header di ogni pagina, che permette di raggiungere qualsiasi ricetta del sito a partire da parole chiave. \newline
Per gli utenti che invece vogliono esplorare e scoprire nuove ricette, la home page offre degli spunti mostrando le ricette migliori per ogni categoria, in base alla valutazione degli utenti. \newline
L'utente generico può creare un proprio account tramite la funzionalità di registrazione. \newline
L'utente registrato potrà accedere al proprio account ogni volta che lo desidera. 
...
\begin{itemize}
    ...
    \item visualizzare i commenti degli altri utenti; % bruttissima questa cosa
