<div id="content">
       ...
       <p class="add-edit-ricetta-info">Si invita l'amministratore ad
              aggiungere eventuali parole straniere con la seguente
              sintassi: [lingua=parola]. Esempio: [fr=<span
                    xml:lang="fr">coque</span>]</p>
                     ...
                     <ul class="form-container">
                            <li class="form-element">
                                   ...
                                   <span id="add-nome-message"
                                         class="warning">
                                          <errorNomePlaceholder />
                                   </span>
                            </li>
                            <li class="form-element">
                                   <label for="add-immagine">
                                          Immagine:</label>
                                   <input class="barra-input"
                                          type="file"
                                          id="add-immagine"
                            ...
                            <li>
                                   ...
                                   <ul>
                                          <li
                                              class="item-radio-container">
                                                 <label
                                                        for="primo">Primo</label>
                                   ...
                                   <span id="add-tipo-message"
                                         class="warning">
                                          <errorTipoPlaceholder />
                                   </span>
                            </li>
                            <li class="form-element">
                                   <label class="form-label"
                                          for="add-difficolta">
                                          Difficolt&agrave; della
                                   ...
                                   <span id="add-difficolta-message"
                                         class="warning">
                                          <errorDifficoltaPlaceholder />
                                   </span>
                            </li>
                            <li class="form-element">
                                   <label class="form-label"
                                          for="add-tempo"> Tempo (in
                                          minuti)*: </label>
                                   <input class="barra-input"
                                          id="add-tempo"
                                          type="text"
                                   ...
                                   <span id="add-tempo-message"
                                         class="warning">
                                          <errorTempoPlaceholder />
                                   </span>
                            </li>
                            <li class="form-element">
                                   <label class="form-label"
                                          for="add-ingredienti">
                                          Ingredienti (separati da
                                          virgola)*: </label>
                                   <textarea rows=""
                                             cols=""
                                             class="barra-input"
